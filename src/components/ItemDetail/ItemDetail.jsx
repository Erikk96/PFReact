...
function ItemDetail({ detalle }) {
  ...
  document.title = `Malanzan Shop - ${detalle.category}/${detalle.name}`;
          ...
          <div className="col-sm-6 col-md-6 col-lg-6 push-bit text-center">
            <div className="clearfix py-3">
              <div className="pull-right">
                <h1><strong className="textoProd">{detalle.name}</strong><br /></h1>
                <hr />
            <span>
              {detalle.description}
            </span>
            ...
            <hr />
                <span className="h2"><strong><button className='botonItem'> Precio $ {detalle.price} </button></strong>
                  {estaEnCarrito(detalle.id) ?
